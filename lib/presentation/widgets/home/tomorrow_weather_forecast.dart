...
class TomorrowWeatherForecast extends StatelessWidget {
  const TomorrowWeatherForecast({Key? key}) : super(key: key);
        ...
        return BlocSelector<HomeCubit, HomeStates, ChangeIsFoundInTopState>(
          ...
          builder: (context, state) {
            ...
            return Column(
              ...
              children: [
                const BuildTitle(title: StringManager.tomorrowWeatherForecast),
                Container(
                  height: AppSize.s160,
                  ...
                  child: ListView.separated(
                    ...
                    itemBuilder: (context, index) => HourItem(hourModel: context.read<HomeCubit>().weatherModel!.forecast.forecastDay[1].hour[index]),
